...
echo "Legend:"
echo "======="
echo " BL_*: relates to baseline run on original bench file"
echo " RS_*: relates to all runs on the resynthesized bench files"
echo " *_1/2: relates to key variant 1/2 of the SCOPE attack"
echo " *_Bits_*: bit-level stats for related SCOPE run(s); format: #correct / #incorrect / #undecided / #total key-bits"
...
echo " *_COPE*: COPE metric as reported by SCOPE; for RS runs, note that min, max, and avg COPE values are reported"
